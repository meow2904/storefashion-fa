...
export function MobileMenu({ items }: { items: MenuItem[] }) {
    ...
    const menuOverlay = (
        <div className={cn("fixed inset-0 z-50 bg-white transition-transform duration-300", isOpen ? "translate-x-0" : "translate-x-full")}>
    ...
    return (
        <div className="lg:hidden">
            <button onClick={() => setIsOpen(true)} className="p-2"><Menu size={20} /></button>
